      ...
      <div className="relative z-10 container-custom px-4">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/20 border border-primary/40 rounded-full mb-6 animate-fade-up">
            ...
            <span className="text-sm font-medium text-primary">Overall Runner-Up GKD 2025</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-8 animate-fade-up" style={{ animationDelay: "0.2s" }}>
            LuasKart Industries Pvt. Ltd. is a manufacturer of CV and EV go-karts, delivering reliable, high-performance mobility solutions for commercial and recreational applications.
          </p>
